...
type Props = {
  todo: TodoType;
  toggleCompleteStatusOnTodo: (id: string) => void;
  delTodo: (id: string) => void;
};

function TodoItem({ todo, toggleCompleteStatusOnTodo, delTodo }: Props) {
  let textDecorationClass = todo.completed ? "line-through" : "no-underline";
  let textColorClass = todo.completed ? "text-pink-600" : "text-gray-800";
  ...
  return (
    ...
    >
      <input
        ...
        onChange={() => toggleCompleteStatusOnTodo(todo.id)}
